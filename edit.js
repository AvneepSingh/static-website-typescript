import { contactDataList, loadData } from './data.js';
...
const saveEditedContact = (index) => {
    ...
    const nemail = document.getElementById('edit-email').value;
    const nphone = document.getElementById('edit-phone').value;
    const ndesg = document.getElementById('edit-desg').value;
...
const backToDetailsByindex = (index) => {
